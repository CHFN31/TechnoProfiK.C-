...
{
    public partial class Divisions : MaterialForm
    {
        ...
        private void LoadDataFromDatabase()
        {
            ...
            {
                connection.Open();
                string sqlQuery = "SELECT ИдентификаторПодразделения, НазваниеПоздразделения, РуководительПодразделения, Описание FROM Подразделения";
        ...
        {
            DivisionsAdd da = new DivisionsAdd();
            da.ShowDialog();
        }

        private void materialButton2_Click(object sender, EventArgs e)
        {
            DivisionsChange dc = new DivisionsChange();
            dc.ShowDialog();
        }

        private void materialButton3_Click(object sender, EventArgs e)
        {
            DivisionsDelete dd = new DivisionsDelete();
            dd.ShowDialog();
        }
    }
}
