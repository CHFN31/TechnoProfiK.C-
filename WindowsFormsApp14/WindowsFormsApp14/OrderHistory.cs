...
{
    public partial class OrderHistory : MaterialForm
    {
        ...
        private void LoadDataFromDatabase()
        {
            ...
            {
                connection.Open();
                string sqlQuery = "SELECT  ИдентификаторЗаписи, ИдентификаторЗаказа, ИдентификаторТовара, КоличествоТовара, Сумма FROM ИсторияЗаказов";
        ...
        {
            OrderHistoryAdd oha = new OrderHistoryAdd();
            oha.ShowDialog();
        }

        private void materialButton2_Click(object sender, EventArgs e)
        {
            OrderHistoryChange ohc = new OrderHistoryChange();
            ohc.ShowDialog();
        }

        private void materialButton3_Click(object sender, EventArgs e)
        {
            OrderHistoryDelete ohd = new OrderHistoryDelete();
            ohd.ShowDialog();
        }
    }
}
