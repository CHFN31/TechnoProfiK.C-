...
{
    public partial class JobTitles : MaterialForm
    {
        ...
        private void LoadDataFromDatabase()
        {
            ...
            {
                connection.Open();
                string sqlQuery = "SELECT ИдентификаторПоставщика, НазваниеКомпании, КонтактноеЛицо, ЭлектроннаяПочта, Телефон, Адрес FROM Поставщики";
        ...
        {
            JobTitlesAdd jta = new JobTitlesAdd();
            jta.ShowDialog();
        }

        private void materialButton2_Click(object sender, EventArgs e)
        {
            JobTitlesChange jtc = new JobTitlesChange();
            jtc.ShowDialog();
        }

        private void materialButton3_Click(object sender, EventArgs e)
        {
            JobTitlesDelete jtd = new JobTitlesDelete();
            jtd.ShowDialog();
        }
