...
namespace WindowsFormsApp14
{
    public partial class Users : MaterialForm
    {
        ...
        private void LoadDataFromDatabase()
        {
            ...
            {
                connection.Open();
                string sqlQuery = "SELECT ИдентификаторПользователя, Логин, Пароль, Роль, Имя, Фамилия, Отчество, ДатаРождения FROM Пользователи";
        ...
        {
            UsersChange uc = new UsersChange();
            uc.ShowDialog();
        }

        private void materialButton3_Click(object sender, EventArgs e)
        {
            UsersDelete ud = new UsersDelete();
            ud.ShowDialog();
        }
