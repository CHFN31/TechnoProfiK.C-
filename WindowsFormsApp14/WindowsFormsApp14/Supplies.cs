...
{
    public partial class Supplies : MaterialForm
    {
        ...
        private void LoadDataFromDatabase()
        {
            ...
            {
                connection.Open();
                string sqlQuery = "SELECT  ИдентификаторПоставки, ИдентификаторТовара, ДатаПоставки, Поставщик, ОбщаяСумма FROM Поставки";
        ...
        {
            SuppliesAdd sa = new SuppliesAdd();
            sa.ShowDialog();
        }

        private void materialButton2_Click(object sender, EventArgs e)
        {
            SuppliesChange sc = new SuppliesChange();
            sc.ShowDialog();
        }

        private void materialButton3_Click(object sender, EventArgs e)
        {
            SuppliesDelete sd = new SuppliesDelete();
            sd.ShowDialog();
        }
